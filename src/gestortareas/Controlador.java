...
/* muestra la vista al usuario */   
  ...
  //___________________________________________________________________________________ Soy una barra separadora :)
    ...
    if(comando.equals("Iniciar Sesion")) form_sesion();
 ...
 model.insertarUusario(this.isesion.usuario.getText(),this.isesion.pass.getText());
    ...
    if(comando.equals("Log")) 
        ...
        }else JOptionPane.showMessageDialog(null,"Usuario incorrecto, vuelva a intentarlo.","Usuario incorrecto",JOptionPane.ERROR_MESSAGE);
}
